<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableList" :border="true" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分组" prop="groupName" width="80" :show-overflow-tooltip="true"/>
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="可筛选" prop="isSelect">
              <el-switch
...
import cat from "@/views/ecps/item/cat";
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      detail(row.featureId).then(res => {
        ...
        if (f.selectValues && f.selectValues !== '') {
          ...
          // this.form.selectValuesArr = f.selectValues.split(',');
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          this.form.isSpec = 0;
          // this.form.selectValues = this.form.selectValuesArr.join(',');
