...
import cc.ussu.modules.ecps.search.model.*;
import cc.ussu.modules.ecps.search.repository.*;
...
public class SkuIndexService {
     ...
     * 分页
     */
    public JsonResult findPage(SearchParam searchParam) {
        ...
        if (catId != null) {
            ...
            return MybatisPlusUtil.getResult(total, resultList);
        }
        return null;
    }
