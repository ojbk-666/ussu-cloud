...
import cn.ussu.modules.ecps.item.mapper.EbFeatureGroupMapper;
import cn.ussu.modules.ecps.item.mapper.EbFeatureMapper;
import cn.ussu.modules.ecps.item.service.IEbFeatureGroupService;
...
public class EbFeatureGroupServiceImpl extends ServiceImpl<EbFeatureGroupMapper, EbFeatureGroup> implements IEbFeatureGroupService {
    ...
    public void del(String ids) {
        ...
        qw.in(EbFeatureGroup::getGroupId, ids);
        super.remove(qw);
    }
