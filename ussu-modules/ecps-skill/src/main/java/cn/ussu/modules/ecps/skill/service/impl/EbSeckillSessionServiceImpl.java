...
import cn.ussu.modules.ecps.skill.feign.RemoteSkuService;
import cn.ussu.modules.ecps.skill.mapper.EbSeckillSessionMapper;
...
public class EbSeckillSessionServiceImpl extends ServiceImpl<EbSeckillSessionMapper, EbSeckillSession> implements IEbSeckillSessionService {
    ...
    public static final String SKILL_SESSIONS_PREFIX = "ecps:skill:sessions:";
    public static final String SKILL_SKU = "ecps:skill:sku";
    public static final String SKILL_STOCK_PREFIX = "ecps:skill:stock:";
