...
import cc.ussu.modules.ecps.skill.entity.EbSeckillSku;
import cc.ussu.modules.ecps.skill.service.IEbSeckillSkuService;
...
public class EbSeckillSkuController extends BaseAdminController {

    @Autowired
    private IEbSeckillSkuService service;

    /**
     * 分页
     */
    @GetMapping
    public JsonResult page(EbSeckillSku p) {
     ...
     */
    @PutMapping
    public JsonResult add(@RequestBody EbSeckillSku obj) {
        service.add(obj);
     ...
     */
    @PostMapping
    public JsonResult edit(@RequestBody EbSeckillSku obj) {
        service.edit(obj);
        return JsonResult.ok();
    }
