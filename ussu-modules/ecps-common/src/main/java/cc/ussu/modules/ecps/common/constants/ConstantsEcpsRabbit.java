...
public interface ConstantsEcpsRabbit {
    ...
    String EXCHANGE_SKILL_ORDER = "ecps-skill-order-exchange";
    String QUEUE_SKILL_ORDER = "ecps-skill-order-queue";
    String ROUTING_KEY_SKILL_ORDER = "ecps-skill-order-routing-key";
