 ...
 * 高亮实现
 * <p>
 * https://www.pianshen.com/article/8318197295/
 */
@Component
public class DcQuestionHightLightResultMapper extends AbstractResultMapper {

    private final MappingContext<? extends ElasticsearchPersistentEntity<?>, ElasticsearchPersistentProperty> mappingContext;

    public DcQuestionHightLightResultMapper() {
        this(new SimpleElasticsearchMappingContext());
    }

    public DcQuestionHightLightResultMapper(MappingContext<? extends ElasticsearchPersistentEntity<?>, ElasticsearchPersistentProperty> mappingContext) {
    ...
    public DcQuestionHightLightResultMapper(EntityMapper entityMapper) {
